...
\subsection{Journals}
\cvitem{2022}{G. Amati, S. Angelini, D. Pasquini, P. Vocca, A. Cruciani, Distance-based metrics computation on Very Large Graphs [Transactions on Knowledge Discovery from Data (TKDD)] \color{gray}{(\underline{SUBMITTED)}}}
\newpage
...
\cvlistdoubleitem{Dynamic Graphs}{Random Graphs}
