...
\cventry{}{Address}{}{}{Viale Luigi Rendina 26-28, L'Aquila (AQ), Italy}{}
...
\cvitem{2019}{A. Cruciani, D. Pasquini, G. Amati, and P. Vocca, About Graph Index Compression Techniques, Proceedings of the 10th Italian Information Retrieval Workshop (IIR-2019), Padua, Italy, September 16-18, 2019.}
%\newpage
\subsection{Preprints}
\cvitem{2024}{A. Cruciani. Fast Estimation of Percolation Centrality.}
\cvitem{2024}{J. Augustine, A. Cruciani I.A. Gillani. Maintaining Distributed Data Structures in Dynamic Peer-to-Peer Networks.}
\section{Seminars and Presentations}
\cvitem{September 2024}{MANTRA: Temporal Betweenness Centrality Approximation through Sampling. European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases (ECML-PKDD), Vilnius. }
\cvitem{July 2024}{Computing Distance-based metrics on Very Large Graphs. University of Padua. }
\cvitem{September 2023}{PROPAGATE: A Seed Propagation Framework to Compute Distance-Based Metrics on Very Large Graphs. European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases (ECML-PKDD), Turin}
\cvitem{July 2023}{Proxying Betweenness Centrality Rankings in Temporal Networks. 21st International Symposium on Experimental Algorithms (SEA), Barcelona. }
\cvitem{January 2023}{Dynamic graph models inspired by the Bitcoin network-formation process. 24th nternational Conference on Distributed Computing and Networking (ICDCN), IIT Kharagpur January.}
\cvitem{November 2022}{Dynamic graph models for the Bitcoin P2P network: simulation analysis for expansion and flooding time. 24th International Symposium on Stabilization, Safety, and Security of Distributed Systems (SSS), Clermont-Ferrand.}
\cvitem{September 2019}{About Graph Index Compression Techniques. Proceedings of the 10th Italian Information Retrieval Workshop (IIR-2019), Padua.}
\cvitem{June 2019}{Iterative Compression technique for NP-Hard problems on Graphs. University of Rome Tor Vergata.}
\section{Schools}
...
\cvitem{Reviewer}{FUN 2020,2024}
\cvitem{Reviewer}{AAMAS 2023}
%----------------------------------------------------------------------------------------
